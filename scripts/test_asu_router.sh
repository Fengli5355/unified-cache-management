...
TEST_FILTER="${TEST_FILTER:-RouterTest.*}"
...
cmake --build "${BUILD_DIR}" --target kv_common.test --parallel "${BUILD_JOBS}"

TEST_BIN="${BUILD_DIR}/ucm/transport/kv/common/kv_common.test"
