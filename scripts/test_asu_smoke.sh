...
TEST_FILTER="${TEST_FILTER:-AsuSmokeTest.*:AsuClientE2EMetricsTest.*:ConnectionManagerTest.*:ConnectionTransportTest.*:ConnectionConcurrentTest.*:SqePackTest.*:LinkProtoPackTest.*}"
